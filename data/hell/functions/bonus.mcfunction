...
execute if score fake3 Bonus matches 0..19 run effect give @a poison 8 0
execute if score fake3 Bonus matches 0..19 run tellraw @a {"text":"真不幸，你中毒了！下次小心！","color":"dark_green","bold": true}
execute if score fake3 Bonus matches 20..30 run give @a oak_log 10
execute if score fake3 Bonus matches 20..30 run tellraw @a {"text":"收下吧，这是我唯一的礼物了！","color": "white","bold":true}
...
execute if score fake3 Bonus matches 36..39 run effect give @a resistance 600 3
execute if score fake3 Bonus matches 36..39 run tellraw @a {"text":"几乎无敌的600秒，尽情享受吧！","color":"dark_gray","bold": true}
execute if score fake3 Bonus matches 40 run give @a diamond 2
execute if score fake3 Bonus matches 40 run tellraw @a {"text":"大惊喜！你获得了两个钻石！你真是个欧皇！","color":"blue","bold": true}
execute if score fake3 Bonus matches 41..50 run give @a iron_ingot 5
execute if score fake3 Bonus matches 41..50 run tellraw @a {"text":"来硬的！","color":"gray","bold": true}
...
#50%的概率出好运，30%的概率出厄运，20%的概率无事发生